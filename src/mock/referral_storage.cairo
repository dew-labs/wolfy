...
trait IReferralStorage<TContractState> {
    ...
    fn get_trader_referral_info(self: @TContractState, account: ContractAddress) -> (felt252, ContractAddress);
...
mod ReferralStorage {
    ...
    use freyr::mock::governable::{IGovernableDispatcherTrait, IGovernableLibraryDispatcher};
    use freyr::referral::referral_tier::ReferralTier;
    ...
    impl ReferralStorageImpl of super::IReferralStorage<ContractState> {
        ...
        fn register_code(ref self: ContractState, code: felt252) {
            ...
            assert(self.code_owners.read(code) == contract_address_const::<0>(), MockError::CODE_ALREADY_EXISTS);
