...
import { decimalToFloat, ensureDeployed, expandDecimals, getKey, settingUp } from "../../utils";
...
async function createMarket() {
    ...
    await config(chainId, account, marketTokenAddress, longTokenAddress, shortTokenAddress);
